        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton('🔖 Projects Channel', url='https://t.me/Mo_Tech_YT')
                ],
                [
                    InlineKeyboardButton('💡 Source Code', url='https://github.com/MoTechYT/MT-Screenshot-Bot'),
                    InlineKeyboardButton('👨 Master', url='https://t.me/MRK_YT')
                ],
                [
                    InlineKeyboardButton('🖥️ Tutorial Video 🖥️', url='https://github.com/MoTechYT/MT-Screenshot-Bot')
                ]
            ]
        )
    )
